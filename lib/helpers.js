(function(root, factory) {
  ...
  dust.helpers.component = function component(chunk, context, bodies, params) {
    ...
    for (var name in bodies) {
      ...
      // TODO PLZ FOR THE LOVE OF GAWD
      //
      // Check that this regex actually matches if and only if the body really
      // is empty.
      if (name === 'block' && !(/\{\s*return chk;\s*\}/.test(bodies.block.toString()))) {
